...
/**
 * Given an array of scores, compute the int average of the 
 ...
 * between indexes start..end. Call your helper method twice to 
 * implement scoresAverage(). Write your helper method after your 
 * scoresAverage() method in the JavaBat text area. 
...
public class scoresAverage {
	...
	public static void main(String[] args) {
		int[] scores = new int[]{3, 4, 5, 1, 2, 3};
