 ...
 * walking trail. Given start/end indexes into the array, 
 * return the sum of the changes for a walk beginning at the start 
 * index and ending at the end index. For example, with the heights 
...
public class SumHeights {
	...
	public static void main(String[] args) {
		...
		System.out.println(sumHeights(words, 2, 4));
	}
