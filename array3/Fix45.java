 ...
 * given array, but rearranged so that every 4 is immediately 
 * followed by a 5. Do not move the 4's, but every other number may move. 
 * The array contains the same number of 4's and 5's, and every 4 has a 
...
public class Fix45 {
	...
	public static void main(String[] args) {
		int[] nums = new int[]{1, 4, 1, 5, 5, 4, 1};
